...
$.widget( "ui.geo_autocomplete", {
  ...
  options: {
	...
	var _bounds = new google.maps.LatLngBounds(new google.maps.LatLng(18,73), new google.maps.LatLng(20,75));
	this.options._geocoder.geocode({'address': _address, 'bounds': _bounds}, function(_results, _status) {
	  var _parsed = [];
